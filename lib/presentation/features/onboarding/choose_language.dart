...
class _ChooseLanguageState extends State<ChooseLanguage> {
  ...
  final _chooseLanguageTracker = ChooseLanguageTracker();
  ...
  void _onTrackPush() {
    _chooseLanguageTracker.timeStart = DateTime.now();
  }

  void _onTrackExit() {
    sl<MsObSelectLanguageTrackingUsecase>().call(
      MsObSelectLanguageParams(
        language: selectedLanguage!,
        timeOnScreen:
            DateTime.now()
                .difference(_chooseLanguageTracker.timeStart)
                .inSeconds,
      ),
    );
  }
